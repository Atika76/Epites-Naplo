...
function openMediaViewerFromTile(button, type = 'image', title = '') {
  const src = button?.dataset?.src || button?.closest?.('.mediaTile,.reportMediaTile,figure,.v121Photo,.v134Photo,.v67ReportPhoto,.photos,.v70PhotoBlock')?.querySelector?.('img,video')?.getAttribute?.('data-full-src') || button?.closest?.('.mediaTile,.reportMediaTile,figure,.v121Photo,.v134Photo,.v67ReportPhoto,.photos,.v70PhotoBlock')?.querySelector?.('img,video')?.currentSrc || button?.closest?.('.mediaTile,.reportMediaTile,figure,.v121Photo,.v134Photo,.v67ReportPhoto,.photos,.v70PhotoBlock')?.querySelector?.('img,video')?.src || '';
  if(type === 'video') return openMediaInNewTab(src, type, title || 'Munkavideó');
  if(window.EpitesNaploUnifiedPhotoViewer?.openBySrc) return window.EpitesNaploUnifiedPhotoViewer.openBySrc(src, title || 'Napló fotó');
  return false;
}
...
function ensureMediaViewerModal() {
  try { document.getElementById('mediaViewerModal')?.remove(); } catch(_) {}
  return null;
}
...
window.closeMediaViewer = function() {
  try { document.getElementById('mediaViewerModal')?.remove(); document.querySelectorAll('.mediaViewerModal,.v67Lightbox,.v74Lightbox,.v86Lightbox,.v100Lightbox,#v77Lightbox').forEach(el=>el.remove()); document.body.classList.remove('mediaViewerOpen'); } catch(_) {}
};
...
(function(){
  ...
  async function fallbackHtml(){
    ...
    return `<!doctype html><html lang="hu"><head><link rel="icon" type="image/png" sizes="192x192" href="https://epitesi-naplo.eu/favicon.png"><link rel="shortcut icon" href="https://epitesi-naplo.eu/favicon.ico"><link rel="apple-touch-icon" href="https://epitesi-naplo.eu/favicon.png"><meta name="theme-color" content="#0f172a"><meta charset="utf-8"><title>Ugyfel visszajelzes</title></head><body><h1>Ugyfel visszajelzes</h1></body></html>`;
  }
  async function approvalHtml(id){
    ...
    if(!/<!doctype|<html/i.test(html)) html = `<!doctype html><html lang="hu"><head><link rel="icon" type="image/png" sizes="192x192" href="https://epitesi-naplo.eu/favicon.png"><link rel="shortcut icon" href="https://epitesi-naplo.eu/favicon.ico"><link rel="apple-touch-icon" href="https://epitesi-naplo.eu/favicon.png"><meta name="theme-color" content="#0f172a"><meta charset="utf-8"><title>Ugyfel visszajelzes</title></head><body>${html}</body></html>`;
...
(function(){
  ...
  async function fallbackReportHtml(){
    ...
    return `<!doctype html><html lang="hu"><head><link rel="icon" type="image/png" sizes="192x192" href="https://epitesi-naplo.eu/favicon.png"><link rel="shortcut icon" href="https://epitesi-naplo.eu/favicon.ico"><link rel="apple-touch-icon" href="https://epitesi-naplo.eu/favicon.png"><meta name="theme-color" content="#0f172a"><meta charset="utf-8"><title>${esc(title)}</title></head><body><h1>${esc(title)}</h1><p>A riport snapshot nem toltheto be, de az ugyfel visszajelzes adatai rogzitve vannak.</p></body></html>`;
  }
  function withApprovalStamp(html, row = {}){
    ...
    let out = String(html || '');
    if(!/<!doctype|<html/i.test(out)) out = `<!doctype html><html lang="hu"><head><link rel="icon" type="image/png" sizes="192x192" href="https://epitesi-naplo.eu/favicon.png"><link rel="shortcut icon" href="https://epitesi-naplo.eu/favicon.ico"><link rel="apple-touch-icon" href="https://epitesi-naplo.eu/favicon.png"><meta name="theme-color" content="#0f172a"><meta charset="utf-8"><title>Ugyfel visszajelzes</title></head><body>${out}</body></html>`;
...
(function(){
  ...
  function v74ReportHtml(entries, title, options={}){
    ...
    return `<!doctype html><html lang="hu"><head><link rel="icon" type="image/png" sizes="192x192" href="https://epitesi-naplo.eu/favicon.png"><link rel="shortcut icon" href="https://epitesi-naplo.eu/favicon.ico"><link rel="apple-touch-icon" href="https://epitesi-naplo.eu/favicon.png"><meta name="theme-color" content="#0f172a"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${v74Esc(title)}</title><style>
  ...
  async function v74ApprovalHtml(id){
    ...
    if(!/<!doctype|<html/i.test(html)) html = `<!doctype html><html lang="hu"><head><link rel="icon" type="image/png" sizes="192x192" href="https://epitesi-naplo.eu/favicon.png"><link rel="shortcut icon" href="https://epitesi-naplo.eu/favicon.ico"><link rel="apple-touch-icon" href="https://epitesi-naplo.eu/favicon.png"><meta name="theme-color" content="#0f172a"><meta charset="utf-8"><title>Jóváhagyott riport</title></head><body>${html}</body></html>`;
    return { html, row };
  }
  window.v71DownloadApprovedHtml = async function(approvalId){
    try{
...
(function(){
  ...
  function improveReportHtml(html){
    let out = String(html || '');
    if(!/<!doctype|<html/i.test(out)) out = `<!doctype html><html lang="hu"><head><link rel="icon" type="image/png" sizes="192x192" href="https://epitesi-naplo.eu/favicon.png"><link rel="shortcut icon" href="https://epitesi-naplo.eu/favicon.ico"><link rel="apple-touch-icon" href="https://epitesi-naplo.eu/favicon.png"><meta name="theme-color" content="#0f172a"><meta charset="utf-8"><title>Riport</title></head><body>${out}</body></html>`;
    try{
  ...
  async function currentFullReport(){
    ...
    return `<!doctype html><html lang="hu"><head><link rel="icon" type="image/png" sizes="192x192" href="https://epitesi-naplo.eu/favicon.png"><link rel="shortcut icon" href="https://epitesi-naplo.eu/favicon.ico"><link rel="apple-touch-icon" href="https://epitesi-naplo.eu/favicon.png"><meta name="theme-color" content="#0f172a"><meta charset="utf-8"><title>${esc(projectTitle())}</title></head><body><h1>${esc(projectTitle())}</h1><p>A riport adatai nem tolthetok be.</p></body></html>`;
  }
...
(function(){
  ...
  function stamp(html,row){
    let out = String(html || '');
    if(!/<!doctype|<html/i.test(out)) out = `<!doctype html><html lang="hu"><head><link rel="icon" type="image/png" sizes="192x192" href="https://epitesi-naplo.eu/favicon.png"><link rel="shortcut icon" href="https://epitesi-naplo.eu/favicon.ico"><link rel="apple-touch-icon" href="https://epitesi-naplo.eu/favicon.png"><meta name="theme-color" content="#0f172a"><meta charset="utf-8"><title>${esc(ptitle())}</title></head><body>${out}</body></html>`;
  ...
  async function currentReport(){
    ...
    return `<!doctype html><html lang="hu"><head><link rel="icon" type="image/png" sizes="192x192" href="https://epitesi-naplo.eu/favicon.png"><link rel="shortcut icon" href="https://epitesi-naplo.eu/favicon.ico"><link rel="apple-touch-icon" href="https://epitesi-naplo.eu/favicon.png"><meta name="theme-color" content="#0f172a"><meta charset="utf-8"><title>${esc(ptitle())}</title></head><body><h1>${esc(ptitle())}</h1><p>A riport pillanatnyilag nem építhető újra.</p></body></html>`;
  }
  async function approvalRow(id){
...
(function(){
  ...
  async function currentReportHtml(){
    ...
    const entries = data?.entries || state()?.entries || [];
    const builder = window.buildProReportHtml || (typeof buildProReportHtml === 'function' ? buildProReportHtml : null);
    return builder ? builder(entries, `${projectTitle()} – jóváhagyott riport`, data || {}) : `<!doctype html><html lang="hu"><head><link rel="icon" type="image/png" sizes="192x192" href="https://epitesi-naplo.eu/favicon.png"><link rel="shortcut icon" href="https://epitesi-naplo.eu/favicon.ico"><link rel="apple-touch-icon" href="https://epitesi-naplo.eu/favicon.png"><meta name="theme-color" content="#0f172a"><meta charset="utf-8"><title>${esc(projectTitle())}</title></head><body><h1>${esc(projectTitle())}</h1><p>A riport pillanatnyilag nem építhető újra.</p></body></html>`;
  }
...
// ===== V152: régi képnéző végleges tiltása és minden riport HTML új képnézőre kényszerítése =====
(function(){
  if(window.__v152NoOldImageViewerEver) return;
  window.__v152NoOldImageViewerEver = true;
  const OLD_SELECTORS = '#mediaViewerModal,.mediaViewerModal,#v67Lightbox,.v67Lightbox,.v134Lightbox,.v121Lightbox,.v118Lightbox,.v110Gallery,.v103Lightbox,.v102Lightbox,.v100Lightbox,.v86Lightbox,.v79ReportLightbox,.v79GalleryModal,#v77Lightbox,.v77Lightbox,.v74Lightbox,.v150ReportViewer';
  function killOld(){ try{ document.querySelectorAll(OLD_SELECTORS).forEach(el=>el.remove()); document.body.classList.remove('mediaViewerOpen'); document.documentElement.classList.remove('mediaViewerOpen'); }catch(_){} }
  function openNew(src,title){ killOld(); if(!src) return false; if(window.EpitesNaploUnifiedPhotoViewer?.openBySrc) return window.EpitesNaploUnifiedPhotoViewer.openBySrc(src,title||'Napló fotó'); return false; }
  window.openMediaViewer = function(src,type,title){ if(type==='video'){ if(src) window.open(src,'_blank','noopener'); return false; } return openNew(src,title); };
  window.openMediaViewerFromTile = function(button,type,title){
    if(type==='video'){ const v=button?.closest?.('.mediaTile,.reportMediaTile,figure,.v70PhotoBlock')?.querySelector?.('video'); const s=v?.currentSrc||v?.src||button?.dataset?.src||''; if(s) window.open(s,'_blank','noopener'); return false; }
    const img = button?.closest?.('.mediaTile,.reportMediaTile,figure,.v121Photo,.v134Photo,.v67ReportPhoto,.photos,.v70PhotoBlock')?.querySelector?.('img');
    const src = img?.getAttribute?.('data-full-src') || img?.currentSrc || img?.src || button?.dataset?.src || '';
    return openNew(src,title || img?.alt || 'Napló fotó');
  };
  window.openReportMediaLink = function(event,link){ if(event){ event.preventDefault(); event.stopPropagation(); event.stopImmediatePropagation&&event.stopImmediatePropagation(); } const img=link?.querySelector?.('img')||link?.closest?.('figure,.photo,.v67ReportPhoto,.v74Photo,.mediaTile,.reportMediaTile')?.querySelector?.('img'); const src=img?.getAttribute?.('data-full-src')||img?.currentSrc||img?.src||link?.href||''; return openNew(src,img?.alt||'Napló fotó'); };
  window.v74OpenReportPhoto = window.v77OpenPhoto = window.v86OpenPhoto = window.v100OpenPhoto = function(src){ return openNew(src,'Napló fotó'); };
  const STANDALONE = `<style id="v152StandaloneViewerCss">.v152Viewer{position:fixed;inset:0;background:rgba(2,6,23,.88);z-index:2147483647;display:none;color:#fff;font-family:Arial,Helvetica,sans-serif}.v152Viewer.open{display:block}.v152Top{position:absolute;left:0;right:0;top:0;min-height:54px;background:#0f172a;display:flex;align-items:center;justify-content:space-between;gap:8px;padding:8px 10px;box-sizing:border-box}.v152Title{font-weight:800;font-size:14px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.v152Btns{display:flex;gap:6px;align-items:center}.v152Btns button,.v152Nav{border:1px solid rgba(255,255,255,.25);background:#172033;color:#fff;border-radius:10px;padding:8px 10px;font-weight:800;cursor:pointer}.v152Btns .primary{background:#fbbf24;color:#111827;border-color:#fbbf24}.v152Stage{position:absolute;inset:54px 0 0 0;display:flex;align-items:center;justify-content:center;overflow:hidden;padding:16px;box-sizing:border-box;touch-action:none}.v152Stage img{max-width:88vw;max-height:calc(100vh - 100px);object-fit:contain;border-radius:12px;box-shadow:0 20px 60px rgba(0,0,0,.45);transition:transform .08s ease;user-select:none;-webkit-user-drag:none}.v152Stage.full img{max-width:none;max-height:none}.v152Nav{position:absolute;top:50%;transform:translateY(-50%);z-index:3;font-size:32px;border-radius:14px;padding:10px 14px;background:#111827cc}.v152Nav.prev{left:10px}.v152Nav.next{right:10px}@media(max-width:720px){.v152Top{align-items:flex-start;min-height:70px}.v152Btns{flex-wrap:wrap;justify-content:flex-end}.v152Stage{inset:70px 0 0 0}.v152Stage img{max-width:92vw;max-height:calc(100vh - 128px)}.v152Nav{font-size:24px;padding:8px 12px}}</style>`;
  const SCRIPT = `<script>(function(){if(window.__v152StandaloneViewer)return;window.__v152StandaloneViewer=true;var SEL='.photos img,.entryImageGrid img,.reportImageGrid img,.v74Photos img,.v68ReportPhotos img,.v67ReportPhoto img,figure img,img.reportPhoto';var list=[],idx=0,scale=1,tx=0,ty=0,drag=false,sx=0,sy=0;function esc(s){return String(s||'').replace(/[&<>\"]/g,function(c){return {'&':'&amp;','<':'&lt;','>':'&gt;','\"':'&quot;'}[c]||c})}function srcOf(i){return i.getAttribute('data-full-src')||i.currentSrc||i.src||''}function collect(ctx){var root=(ctx&&ctx.closest&&ctx.closest('.entry,.v133Entry,section'))||document;var a=Array.from(root.querySelectorAll(SEL));if(a.length<2)a=Array.from(document.querySelectorAll(SEL));var seen={};return a.filter(function(i){var s=srcOf(i);if(!s||i.closest('.v152Viewer'))return false;if(seen[s])return false;seen[s]=1;return true}).map(function(i,n){return{src:srcOf(i),title:i.alt||'Napló fotó '+(n+1)}})}function stage(){return document.getElementById('v152Stage')}function apply(){var img=stage().querySelector('img');if(img)img.style.transform='translate('+tx+'px,'+ty+'px) scale('+scale+')'}function close(){var v=document.getElementById('v152Viewer');if(v)v.classList.remove('open');document.body.style.overflow=''}function show(n,ctx){list=collect(ctx||document);if(!list.length)return;idx=(n+list.length)%list.length;scale=1;tx=0;ty=0;var v=document.getElementById('v152Viewer');if(!v){v=document.createElement('div');v.id='v152Viewer';v.className='v152Viewer';v.innerHTML='<div class="v152Top"><div id="v152Title" class="v152Title">Napló fotó</div><div class="v152Btns"><button data-a="minus">−</button><button data-a="plus">+</button><button data-a="reset">100%</button><button class="primary" data-a="full">Teljes kép</button><button data-a="close">Bezárás</button></div></div><button class="v152Nav prev">‹</button><div id="v152Stage" class="v152Stage"></div><button class="v152Nav next">›</button>';document.body.appendChild(v);v.querySelector('.prev').onclick=function(e){e.stopPropagation();show(idx-1)};v.querySelector('.next').onclick=function(e){e.stopPropagation();show(idx+1)};v.querySelector('[data-a=close]').onclick=close;v.querySelector('[data-a=minus]').onclick=function(){scale=Math.max(.5,scale-.25);apply()};v.querySelector('[data-a=plus]').onclick=function(){scale=Math.min(5,scale+.25);apply()};v.querySelector('[data-a=reset]').onclick=function(){scale=1;tx=0;ty=0;stage().classList.remove('full');apply()};v.querySelector('[data-a=full]').onclick=function(){stage().classList.toggle('full');scale=stage().classList.contains('full')?Math.max(1.3,scale):1;tx=0;ty=0;apply()};stage().addEventListener('pointerdown',function(e){drag=true;sx=e.clientX-tx;sy=e.clientY-ty;stage().setPointerCapture&&stage().setPointerCapture(e.pointerId)});stage().addEventListener('pointermove',function(e){if(!drag)return;tx=e.clientX-sx;ty=e.clientY-sy;apply()});stage().addEventListener('pointerup',function(){drag=false});v.addEventListener('wheel',function(e){e.preventDefault();scale=Math.max(.5,Math.min(5,scale+(e.deltaY<0?.2:-.2)));apply()},{passive:false});}document.getElementById('v152Title').textContent=(list[idx].title||'Napló fotó')+' ('+(idx+1)+'/'+list.length+')';stage().classList.remove('full');stage().innerHTML='<img src="'+esc(list[idx].src)+'" alt="'+esc(list[idx].title)+'">';v.classList.add('open');document.body.style.overflow='hidden'}document.addEventListener('click',function(e){var img=e.target.closest&&e.target.closest(SEL);if(!img||img.closest('.v152Viewer'))return;e.preventDefault();e.stopPropagation();e.stopImmediatePropagation&&e.stopImmediatePropagation();var l=collect(img);var s=srcOf(img);var n=l.findIndex(function(x){return x.src===s});list=l;show(n<0?0:n,img)},true);document.addEventListener('keydown',function(e){var v=document.getElementById('v152Viewer');if(!v||!v.classList.contains('open'))return;if(e.key==='Escape')close();if(e.key==='ArrowRight')show(idx+1);if(e.key==='ArrowLeft')show(idx-1)});})();<\/script>`;
  function stripOld(html){ let out=String(html||''); out=out.replace(/<script\b[^>]*>[\s\S]*?(?:v86Lightbox|v100Lightbox|v74OpenReportPhoto|v67Lightbox|v77Lightbox|v134Lightbox|v150ReportViewer|mediaViewerModal)[\s\S]*?<\/script>/gi,''); out=out.replace(/\sonclick="[^"]*(?:openMediaViewer|openMediaViewerFromTile|openReportMediaLink|v74OpenReportPhoto|v77|v86|v100|Lightbox)[^"]*"/gi,''); out=out.replace(/\sonclick='[^']*(?:openMediaViewer|openMediaViewerFromTile|openReportMediaLink|v74OpenReportPhoto|v77|v86|v100|Lightbox)[^']*'/gi,''); return out; }
  function inject(html){ let out=stripOld(html); if(!out.includes('v152StandaloneViewerCss')) out=out.includes('</head>')?out.replace('</head>',STANDALONE+'</head>'):STANDALONE+out; if(!out.includes('__v152StandaloneViewer')) out=out.includes('</body>')?out.replace('</body>',SCRIPT+'</body>'):out+SCRIPT; return out; }
  window.v152SanitizeReportHtml = inject;
  const wrapBuild = () => { const b = window.buildProReportHtml || (typeof buildProReportHtml==='function'?buildProReportHtml:null); if(b && !b.__v152Wrapped){ const w=function(){return inject(b.apply(this,arguments));}; w.__v152Wrapped=true; window.buildProReportHtml=w; try{buildProReportHtml=w}catch(_){} } };
  wrapBuild(); setTimeout(wrapBuild,400); setTimeout(wrapBuild,1600);
  if(window.EpitesNaploAPI && !window.EpitesNaploAPI.__v152ReportSanitize){ const api=window.EpitesNaploAPI; ['createPublicReport','saveReportDocument','createReportDocument'].forEach(k=>{ if(typeof api[k]==='function'){ const old=api[k].bind(api); api[k]=function(payload){ try{ if(payload && payload.reportHtml) payload.reportHtml=inject(payload.reportHtml); if(payload && payload.html_content) payload.html_content=inject(payload.html_content); if(payload && payload.html) payload.html=inject(payload.html); }catch(_){} return old(payload); }; } }); api.__v152ReportSanitize=true; }
  document.addEventListener('click',function(e){ const img=e.target.closest&&e.target.closest('.photos img,.entryImageGrid img,.reportImageGrid img,.v74Photos img,.v68ReportPhotos img,.v67ReportPhoto img,figure img,img.reportPhoto,.mediaTile img,.reportMediaTile img'); if(!img||img.closest('#v150UnifiedViewer,#v152UnifiedViewer,.v152Viewer')) return; e.preventDefault(); e.stopPropagation(); e.stopImmediatePropagation&&e.stopImmediatePropagation(); const src=img.getAttribute('data-full-src')||img.currentSrc||img.src; openNew(src,img.alt||'Napló fotó'); }, true);
