...
(function(){
  ...
  function printCss(){
    return '<style>'+
      'html,body{margin:0;width:100%;max-width:100%;background:#fff;color:#111827;font-family:Arial,Helvetica,sans-serif;line-height:1.45;-webkit-text-size-adjust:100%;text-size-adjust:100%}'+
      '*{box-sizing:border-box;max-width:100%} body{padding:18px;overflow-x:hidden}.printReportMobileWrap{width:min(100%,920px);max-width:920px;margin:0 auto;background:#fff}'+
      'h1{font-size:30px;line-height:1.16;margin:12px 0} h2{font-size:22px;line-height:1.2;margin:22px 0 10px} h3{font-size:18px;line-height:1.25;margin:18px 0 8px} p{margin:8px 0}'+
      '.cover{border-bottom:4px solid #f59e0b;margin-bottom:20px;padding-bottom:16px}.stats{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:10px;margin:14px 0}.stat{background:#f3f4f6;border-radius:10px;padding:10px;min-width:0}.stat b{display:block;color:#d97706;font-size:20px}'+
      '.entry{break-inside:avoid;border-left:4px solid #f59e0b;background:#fafafa;margin:14px 0;padding:14px;border-radius:12px;overflow:hidden}.photos,.v74Photos,.v77Photos,.entryImageGrid,.reportImageGrid,.v68ReportPhotos,.v117Photos{display:grid;grid-template-columns:repeat(auto-fill,minmax(95px,1fr));gap:10px;margin:12px 0;justify-content:stretch}.v67ReportPhoto,figure,.photo,.reportMediaTile{width:100%;margin:0;border:1px solid #e5e7eb;border-radius:10px;padding:5px;background:#fff;break-inside:avoid;overflow:hidden}.v67ReportPhoto img,figure img,.photos img,.entryImageGrid img,.reportImageGrid img{width:100%;height:95px;object-fit:cover;border-radius:8px;display:block}.v67ReportPhoto video,figure video{width:160px;max-width:100%;border-radius:8px}figcaption,.v67ReportPhoto span{font-size:10px;color:#64748b;display:block;margin-top:4px;white-space:normal}'+
      'table{width:100%;border-collapse:collapse;table-layout:fixed}td,th{border-bottom:1px solid #e5e7eb;padding:7px;text-align:left;white-space:normal;overflow-wrap:anywhere}'+
      '@media screen and (max-width:760px){body{padding:10px!important}.printReportMobileWrap{width:100%!important;max-width:100%!important;margin:0 auto!important}h1{font-size:24px!important;line-height:1.18!important}h2{font-size:20px!important}h3{font-size:17px!important}p,li,td,th{font-size:14px!important;line-height:1.42!important}.stats{grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:8px!important}.entry{padding:12px!important;margin:12px 0!important}.photos,.v74Photos,.v77Photos,.entryImageGrid,.reportImageGrid,.v68ReportPhotos,.v117Photos{grid-template-columns:repeat(3,minmax(0,1fr))!important;gap:8px!important}.v67ReportPhoto img,figure img,.photos img,.entryImageGrid img,.reportImageGrid img{height:82px!important}}'+
      '@media screen and (max-width:360px){.photos,.v74Photos,.v77Photos,.entryImageGrid,.reportImageGrid,.v68ReportPhotos,.v117Photos{grid-template-columns:repeat(2,minmax(0,1fr))!important}}'+
      '@media print{body{padding:8mm;overflow:visible}.printReportMobileWrap{width:100%;max-width:none}.entry,.v67ReportPhoto,figure{break-inside:avoid;page-break-inside:avoid}.photos,.v74Photos,.v77Photos,.entryImageGrid,.reportImageGrid,.v68ReportPhotos,.v117Photos{grid-template-columns:repeat(4,28mm)!important}.v67ReportPhoto img,figure img,.photos img,.entryImageGrid img,.reportImageGrid img{width:26mm!important;height:26mm!important}}'+
    '</style>';
  }
  ...
  window.downloadPublicPdfV110 = async function(btn){
    ...
    try{
      ...
      const html = '<!doctype html><html lang="hu"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>ÉpítésNapló ügyfélriport PDF</title>'+printCss()+'</head><body><main class="printReportMobileWrap">'+reportContentHtml()+'</main><script>function wi(){var imgs=Array.prototype.slice.call(document.images||[]);return Promise.race([Promise.all(imgs.map(function(i){return i.complete?Promise.resolve():new Promise(function(r){i.onload=r;i.onerror=r;});})),new Promise(function(r){setTimeout(r,3500);})]);}window.addEventListener("load",function(){wi().then(function(){setTimeout(function(){window.focus();window.print();},500);});});<\/script></body></html>';
      w.document.open();
