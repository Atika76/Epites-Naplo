...
(function(){
  ...
  function printCss(){
    return '<style>'+
      ...
      '/* V160 mobile print/aboutblank fix */@media screen and (max-width:760px){html,body{width:100%!important;max-width:100%!important;overflow-x:hidden!important}body{padding:12px!important}.doc,.reportWrap,.publicReportCard,#publicReportContent,main,section{width:100%!important;max-width:100%!important;margin-left:auto!important;margin-right:auto!important}.stats{grid-template-columns:repeat(2,minmax(0,1fr))!important}.entry{width:100%!important;max-width:100%!important;padding:14px!important;margin:14px auto!important}.photos,.v74Photos,.v77Photos,.entryImageGrid,.reportImageGrid,.v68ReportPhotos,.v117Photos{grid-template-columns:repeat(2,minmax(0,1fr))!important;justify-content:center!important}.photo,.v67ReportPhoto,figure{width:100%!important;max-width:100%!important}.photo img,.v67ReportPhoto img,figure img{width:100%!important;max-width:100%!important;height:auto!important;aspect-ratio:1/1!important}h1{font-size:26px!important;line-height:1.16!important}h2{font-size:21px!important}}@media print{body{padding:8mm}.entry,.v67ReportPhoto,figure{break-inside:avoid;page-break-inside:avoid}.photos{grid-template-columns:repeat(4,28mm)}.v67ReportPhoto img,figure img{width:26mm;height:26mm}}'+
    '</style>';
  }
