// V153 - egyetlen végleges képnéző minden oldalra
// ÉpítésNapló AI PRO - V152 egységes képnéző
(function(){
  'use strict';
  if (window.__EpitesNaploUnifiedPhotoViewerV153) return;
  window.__EpitesNaploUnifiedPhotoViewerV153 = true;
  ...
  const OLD = '#mediaViewerModal,.mediaViewerModal,#v67Lightbox,.v67Lightbox,.v134Lightbox,#v134Lightbox,.v121Lightbox,#v121Lightbox,.v118Lightbox,#v118Lightbox,.v110Gallery,#v110Gallery,.v103Lightbox,#v103Lightbox,.v102Lightbox,#v102Lightbox,.v100Lightbox,.v86Lightbox,.v79ReportLightbox,.v79GalleryModal,#v77Lightbox,.v77Lightbox,.v74Lightbox,.v150ReportViewer,#v150ReportViewer,#v137ZoomViewer,.v137ZoomViewer,.v152Viewer,#v152Viewer';
