// V141 – egységes képnéző: régi projektes képnéző maradvány teljes kikapcsolása
...
(function(){
  ...
  const OLD_VIEWERS = ['#mediaViewerModal','.mediaViewerModal','.v134Lightbox','.v100Lightbox','.v86Lightbox','.v79GalleryModal','#v77Lightbox'];
  ...
  function ensureCss(){
    ...
    st.textContent = `
      ...
      body.v140Open #mediaViewerModal,body.v140Open .mediaViewerModal,body.v140Open .v134Lightbox,body.v140Open .v100Lightbox,body.v140Open .v86Lightbox,body.v140Open .v79GalleryModal,body.v140Open #v77Lightbox{display:none!important;visibility:hidden!important;pointer-events:none!important}
  ...
  document.addEventListener('click', function(e){
    ...
    const expandBtn = e.target && e.target.closest && e.target.closest('.mediaExpandBtn,[onclick*=\"openMediaViewer\"],[onclick*=\"openMediaViewerFromTile\"]');
    if(expandBtn && !img){
      const tile = expandBtn.closest('.mediaTile,.reportMediaTile,.v121Photo,.v134Photo,figure');
  ...
  // Régi projektes openMediaViewer és gombos nyitások felülírása: csak a V141 néző maradjon.
  ...
  window.openMediaViewerFromTile = function(button, type, title){
    const tile = button && button.closest && button.closest('.mediaTile,.reportMediaTile,figure,.v121Photo,.v134Photo');
  ...
  window.openReportMediaLink = function(event, link){
    ...
    const tile = link && link.closest && link.closest('.reportMediaTile,.mediaTile,figure,.v121Photo,.v134Photo');
    const img = tile && tile.querySelector && tile.querySelector('img');
    if(img){ hideOldViewers(); openForElement(img); }
    return false;
  };
