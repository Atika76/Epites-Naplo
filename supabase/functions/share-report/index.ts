...
const FALLBACK_IMAGE = `${SITE_URL}/og-ugyfelriport-card.png?v=146`;
...
serve(async (req) => {
  ...
  // V146: a közösségi megosztási kártyához fix, profi OG képet használunk.
  // Így WhatsApp/Facebook/Messenger nem próbál régi riportfotót vagy base64 képet előnézetként olvasni.
  ...
  const imageUrl = new URL(FALLBACK_IMAGE);
